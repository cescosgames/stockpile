...
- **New features** — currently in progress: monthly tasks, miscellaneous one-off tasks, and a dashboard notes author field. Further out: offline sync — work without the Pi, reconnect, and merge changes. Other ideas welcome — open an issue to discuss.
