                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {feedItem && (
                      <p className="text-xs text-text-muted mt-0.5">
                        {task.scoops} {feedItem.servingUnit || "serving"}{task.scoops !== 1 ? "s" : ""} each · {feedItem.name}
                      </p>
                    )}
                  </div>
                  {group.length > 0 && (
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {feedItem && (
                  <p className="text-xs text-text-muted mt-0.5">
                    {task.scoops} {feedItem.servingUnit || "serving"}{task.scoops !== 1 ? "s" : ""} · {((task.scoops ?? 0) * feedItem.scoopSize).toFixed(2)} {feedItem.unit} of {feedItem.name}
                  </p>
                )}
              </div>
              <button
